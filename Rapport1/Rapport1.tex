...
Les échantillons récoltés sont ensuite analysés en laboratoire. Sur des
plateaux de tri, les espèces sont identifiées et dénombrées, bien que
seulement une fraction de chaque échantillon soit étudiée pour estimer
l'abondance globale. Cette méthodologie permet de recueillir des
informations précises sur les populations de macroinvertébrés, qui sont
...
la vitesse du courant, la transparence et la température de l'eau.

Cette étude scientifique vise à analyser comment ces variables
influencent la distribution et la densité des communautés benthiques.
Par exemple, la transparence de l'eau, qui peut refléter la
concentration de matières en suspension, est un facteur potentiellement
crucial, tout comme la température, qui influence directement le
métabolisme des organismes aquatiques. Les résultats de cette recherche
fourniront non seulement une meilleure compréhension des écosystèmes
fluviaux du Québec mais aussi des données essentielles pour la gestion
durable et la conservation des ressources aquatiques de la province.

\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.4\textheight]{"C:/Users/ALEXIS/OneDrive/Bureau/Atelier2_ AlexisGabJust/projet-gab-alex-just/figure_1.png"}
